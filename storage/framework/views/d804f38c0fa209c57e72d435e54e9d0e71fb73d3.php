...
<?php $__env->startSection('content'); ?>
    ...
    <div class="item-show">
        ...
        <div class="info-item">
            ...
            <?php if($sorteio->qtnCotas <= $sorteio->qtnVenda): ?>
    ...
    <div class="info-regulamento">
        ...
        <p id="text-regulamento-disable"><?php echo e($sorteio->regulamento); ?>
...
<!-- 
        ...
        <div class="rodape" style="z-index: 9999;">
            ...
            <div class="compra-automatica">
                ...
                <div class="selecoes">
                    ...
                    <div class="op op-selected" onclick="somar(10,<?php echo e($sorteio->valorCota); ?>)">
 ...
 -->
        ...
        <!--     <span class="span-max info-pisca"> Compra máxima até o momento: <b><?php echo e($max); ?></b> cotas </span>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projetos\laravel\sortemax\sorteio\resources\views/sorteio/user/show.blade.php ENDPATH**/ ?>