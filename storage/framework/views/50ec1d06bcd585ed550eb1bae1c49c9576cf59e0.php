...
<div class="body-pagamento">
   ...
   <div class="alert alert-warning" role="alert">
    ...
    <div class="qr-code">
        ...
        <img class="img-qrcode" src="<?php echo e($pag['qr_codes'][0]['links'][0]['href'] ?? ''); ?>"> 
    ...
    <div class="copia-cola">
        ...
        <div class="input" style="width: 100%;">
            ...
            <textarea id="qr_code_text" style="height:150px; width:100%; word-wrap: break-word; white-space: pre-wrap;"><?php echo e($pag['qr_codes'][0]['text']); ?></textarea>
 ...
 Detalhes da sua compra  </h6>
                                        ...
                                        <div class="infos">
                                            ...
                                            <p><b>Cotas: </b> <?php $__currentLoopData = $venda->cotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e(sprintf("%03s",$cota->number)); ?>,   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> </p>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projetos\laravel\sortemax\sorteio\resources\views/finalizar.blade.php ENDPATH**/ ?>