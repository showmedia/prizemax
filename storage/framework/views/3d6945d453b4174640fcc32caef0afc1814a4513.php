...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="header">
                            ...
                            <?php if(Auth::user()->nivel == 1): ?>
                                <form action="/compras/deletar/<?php echo e(Auth::user()->id); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = Auth::user()->compras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   ...
                                   <?php if($cota->number == $compra->sorteio->sorteado): ?>
                                    ...
                                    <div class="ct premiado"><?php echo e(sprintf("%03s",$cota->number)); ?></div>

                                   <?php else: ?>

                                        <div class="ct"><?php echo e(sprintf("%03s",$cota->number)); ?></div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projetos\laravel\sortemax\sorteio\resources\views/meusnumeros.blade.php ENDPATH**/ ?>